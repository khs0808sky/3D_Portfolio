...
//////////////////////////////////////////////////////////////////////////
// APortfolio_3DCharacter

APortfolio_3DCharacter::APortfolio_3DCharacter()
{
...
void APortfolio_3DCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		//EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APortfolio_3DCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &APortfolio_3DCharacter::Look);
	}
	else
	{
...
void APortfolio_3DCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APortfolio_3DCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
